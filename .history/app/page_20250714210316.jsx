...
const PORTFOLIO_CONFIG = {
  personal: {
    ...
    bio: "I'm a passionate Full Stack Developer , dedicated to building innovative and human-centered digital experiences. My expertise spans modern web technologi.",
    tagline: "Passionate about creating innovative solutions that bridge technology and user experience.",
    detailedBio:
      "My journey in software development, marked by a relentless pursuit of crafting impactful digital solutions. I specialize in full-stack development, seamlessly integrating modern web technologies with cutting-edge AI/ML capabilities. My passion lies in transforming complex ideas into intuitive, high-performance applications, always prioritizing clean code, scalable architectures, and an exceptional user experience.",
    interests: [ "Open Source", "Photography", "Music Production", "Gaming"],
...
export default function Portfolio() {
  ...
  const [projects, setProjects] = useState([
    {
      ...
      description:
        "Full-stack e-commerce solution with React, Node.js, and MongoDB. Features include user authentication, payment integration, and admin dashboard with real-time analytics.",
    ...
    },
    {
      ...
      description:
        "Real-time chat app with AI integration using OpenAI API. Supports multiple users, intelligent responses, and conversation history with advanced NLP features.",
      technologies: ["Next.js", "OpenAI", "Socket.io", "PostgreSQL", "Tailwind"],
      link: "https://example.com",
      github: "https://github.com",
      image: "/placeholder.svg?height=300&width=400",
      category: "AI/ML",
  ...
  const [internships, setInternships] = useState([
    {
      ...
      description:
        "Developed and maintained features for a customer relationship management (CRM) platform using React and Node.js. Contributed to improving system performance by optimizing database queries.",
      technologies: ["React", "Node.js", "PostgreSQL", "Git"],
      logo: "/innovate-solutions-logo.png",
    },
    {
      id: "2",
      ...
      description:
        "Assisted in developing machine learning models for natural language processing tasks. Implemented data preprocessing pipelines and evaluated model performance.",
      technologies: ["Python", "TensorFlow", "Pandas", "Numpy"],
      logo: "/future-ai-labs-logo.png",
    },
  ])
  ...
  function HomePage() {
    const navigationItems = [
      { id: "about", label: "About", icon: <User className="w-6 h-6" />, color: "from-emerald-400 to-teal-400" },
        ...
        >
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
              {[
                { number: "3", label: "Projects", icon: <Rocket className="w-6 h-6" /> },
                { number: "5", label: "Certifications", icon: <Award className="w-6 h-6" /> },
                { number: "5", label: "Technologies", icon: <Code className="w-6 h-6" /> },
                { number: "3", label: "Internships", icon: <Calendar className="w-6 h-6" /> },
                { number: "2", label: "Languages", icon: <ThumbsUp className="w-6 h-6" /> },
              ].map((stat, index) => (
                <div
                  key={index}
  ...
  function AchievementsPage() {
    const achievements = [
      ...
      },
      {
        title: "Team Lead",
        description:
          "Led a team in developing an Online Student Voting System as part of a mini project.",
              ...
              <div className="space-y-12">
                  ...
                  <div className="space-y-8">
                    <div className={`border-l-4 pl-8 relative ${darkMode ? "border-blue-500" : "border-pink-500"}`}>
                      ...
                      <p className={`font-medium mb-3 ${darkMode ? "text-blue-400" : "text-pink-600"}`}>
                        Tech Innovations Inc. • 2023 - Present
                      </p>
                      <ul className={`space-y-2 ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
                        <li className="flex items-start space-x-2">
                          ...
                          ></div>
                          <span>Developed and maintained 15+ web applications using React, Node.js, and MongoDB</span>
                        </li>
                        <li className="flex items-start space-x-2">
                          <div
                            className={`w-2 h-2 rounded-full mt-2 flex-shrink-0 ${
                          ...
                          ></div>
                          <span>Implemented AI/ML features that improved user engagement by 45%</span>
                        </li>
                        <li className="flex items-start space-x-2">
                          <div
                            className={`w-2 h-2 rounded-full mt-2 flex-shrink-0 ${
                          ...
                          ></div>
                          <span>Led a team of 8 developers in agile development environment</span>
                        </li>
                        <li className="flex items-start space-x-2">
                          <div
                            className={`w-2 h-2 rounded-full mt-2 flex-shrink-0 ${
                          ...
                          ></div>
                          <span>Reduced application load times by 60% through optimization techniques</span>
                        </li>
                      </ul>
                    </div>
                ...
                <div>
                  ...
                  <div className={`border-l-4 pl-8 relative ${darkMode ? "border-yellow-500" : "border-amber-500"}`}>
                    ...
                    <p className={darkMode ? "text-gray-300" : "text-gray-600"}>
                      CGPA: 8.7/10 • Relevant Coursework: Data Structures, Algorithms, Web Development, Machine
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                      { category: "Frontend", skills: ["React", "Next.js", "Vue.js", "TypeScript", "Tailwind CSS"] },
                      { category: "Backend", skills: ["Node.js", "Python", "Express", "Django", "GraphQL"] },
                      { category: "Database", skills: ["MongoDB", "PostgreSQL", "MySQL", "Firebase", "Redis"] },
                      { category: "Mobile", skills: ["React Native", "Flutter", "Expo", "iOS", "Android"] },
                      { category: "AI/ML", skills: ["TensorFlow", "PyTorch", "OpenAI API", "Scikit-learn"] },
