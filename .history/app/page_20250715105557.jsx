...
export default function Portfolio() {
  ...
  const [projects, setProjects] = useState([
    {
      id: "1",
      title: "Your Vote-Your ID",
      description:
    "Developed a secure and user-friendly Online Voting System to conduct student elections digitally within a college environment. The platform ensures real-time voting, fair results, and role-based access for both voters and admins",
      technologies: ["HTML","CSS","XAMPP","PHP","JavaScript"],
    ...
    },
    {
      ...
      title: "Alarimfy",
      description:
        "Alarimfy is a smart, responsive alarm web app designed to help users create, manage, and customize alarms from the browser itself. It features a clean UI, a real-time clock, and options for setting recurring alarms.",
