...
const PORTFOLIO_CONFIG = {
  personal: {
    ...
    interests: ["Web Development", "Machine Learning", "Building Projects", "Gaming", "Photography"],
...
export default function Portfolio() {
  ...
  const [certifications, setCertifications] = useState([
    {
      id: "1",
      title: "NPTEL: Data Analysis using Python",
      issuer: "NPTEL (IIT Kharagpur)",
      date: "2024",
      credentialId: "NPTEL-CC-2024-04567",
      icon: <Code className="w-8 h-8" />, // Changed from Server to Code
      logo: "/Nptel.png",
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
              {[
                ...
                { number: "4", label: "Certifications", icon: <Award className="w-6 h-6" /> },
                { number: "10", label: "Technologies", icon: <Code className="w-6 h-6" /> },
                { number: "3", label: "Internships", icon: <Calendar className="w-6 h-6" /> },
                { number: "3", label: "Achievements", icon: <ThumbsUp className="w-6 h-6" /> },
              ].map((stat, index) => (
                <div
                  key={index}
  ...
  function AchievementsPage() {
    const achievements = [
{
  title: "Team Lead - Mini Project",
  description:
    "Led a team of peers in developing a Java-based Online Student Voting System as part of a college mini project. Coordinated tasks, managed development flow, and ensured timely project completion.",
  date: "2024",
...
,
    {
  title: "Speech on Farmers' Contribution",
  description:
    "Delivered a speech on the importance of farmers and their contributions to society during a college seminar. Highlighted agricultural challenges and the need for technological support in farming.",
  date: "2022",
  ...
  description:
    "Led the event management team during diploma college fests, overseeing planning, coordination, and execution of multiple cultural and technical events with active participation from students and faculty.",
  date: "2023",
  icon: <Github className="w-8 h-8" />,
